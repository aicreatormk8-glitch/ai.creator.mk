...
(function () {
  ...
  var dict = {
    ru: {
      ...
      "hero.title": "<span class=\"grad\">AI-креатор и<br />визуальный директор</span>",
      "hero.sub": "Создаю кинематографичный AI-контент, рекламу и премиальные цифровые продукты для брендов, которые стремятся быть исключительными. От fashion-визуализации до luxury-сайтов — каждая деталь создана, чтобы захватывать с первого взгляда.<br><br>Каждый кадр — уровень мирового глянца.",
      ...
      "v.eyebrow": "Отзывы", "v.h2": "Мне доверяют инноваторы",
      ...
      "ct.eyebrow": "Готовы начать?", "ct.h2": "Создадим то, что запомнят", "ct.lead": "Расскажите о замысле — и уже завтра увидите первые концепты. Выберите направление или напишите напрямую.",
      ...
      "f.opt1": "AI-контент (фото / видео)", "f.opt2": "AI-персонаж / инфлюенсер", "f.opt3": "Сайт / лендинг", "f.opt4": "Автоматизация / AI-системы", "f.opt5": "Брендинг и дизайн",
    ...
    en: {
      ...
      "hero.title": "<span class=\"grad\">AI Creator &<br />Visual Director</span>",
      "hero.sub": "I create cinematic AI content, advertising and premium digital products for brands that strive to be exceptional. From fashion visuals to luxury websites — every detail crafted to captivate at first glance.<br><br>Every frame — world-class gloss.",
      ...
      "v.eyebrow": "Reviews", "v.h2": "Trusted by innovators",
      ...
      "ct.eyebrow": "Ready to start?", "ct.h2": "Let's create something unforgettable", "ct.lead": "Tell me about your vision — and see first concepts as soon as tomorrow. Pick a direction or write to me directly.",
      ...
      "f.opt1": "AI content (photo / video)", "f.opt2": "AI character / influencer", "f.opt3": "Website / landing", "f.opt4": "Automation / AI systems", "f.opt5": "Branding & design",
