...
(function () {
  ...
  var dict = {
    ru: {
      ...
      "hero.pill": "AI Creator Studio · Кинематографичный AI-продакшн",
      "hero.title": "Кинематографичный<br /><span class=\"grad\">AI-контент</span> <span class=\"serif\">мирового уровня</span>",
      "hero.sub": "<strong>Marina Kalashnikova</strong> · <span class=\"hero__handle\">@aicreatormk8</span> — AI Creator и специалистка по цифровой автоматизации. Превращаю идеи в премиальный визуал, видео, виртуальные образы, сайты и автоматизированные системы — полный цикл под ваш бренд.",
      ...
      "srv.lead": "Три направления полного цикла: кинематографичный AI-визуал, сайты под ключ и интеллектуальная автоматизация — от идеи до запуска.",
      ...
      "work.lead": "Реальные направления студии — от AI-съёмки до сайтов и автоматизации.",
      ...
      "proc.eyebrow": "Как я работаю", "proc.h2": "Процесс, который выглядит <span class=\"serif\">дорого</span>", "proc.lead": "Прозрачные этапы от первого звонка до запуска и поддержки.",
      ...
      "pr.eyebrow": "Пакеты услуг", "pr.h2": "Прозрачные <span class=\"grad\">тарифы</span>", "pr.lead": "Стартовые цены ориентировочные — финальный расчёт всегда индивидуальный под ваш объём.",
      ...
      "ct.eyebrow": "Готовы начать?", "ct.h2": "Давайте создадим что-то, <span class=\"serif\">что запомнят</span>", "ct.lead": "Расскажите об идее — и уже завтра увидите первые концепты. Выберите направление или напишите мне напрямую.",
      "ct.q1": "Заказать AI-проект", "ct.q2": "Обсудить сайт", "ct.q3": "Создать AI-контент",
      ...
      "ft.tag": "Marina Kalashnikova — AI Creator и специалистка по цифровой автоматизации. Кинематографичный AI-контент и цифровые продукты под ваш бренд.",
    ...
    en: {
      ...
      "hero.pill": "AI Creator Studio · Cinematic AI production",
      "hero.title": "Cinematic <span class=\"grad\">AI content</span><br /><span class=\"serif\">of world-class level</span>",
      "hero.sub": "<strong>Marina Kalashnikova</strong> · <span class=\"hero__handle\">@aicreatormk8</span> — AI Creator and digital automation specialist. I turn ideas into premium visuals, video, virtual personas, websites and automated systems — full cycle for your brand.",
      ...
      "srv.lead": "Three full-cycle directions: cinematic AI visuals, turnkey websites and intelligent automation — from idea to launch.",
      ...
      "work.lead": "Real studio directions — from AI shoots to websites and automation.",
      ...
      "proc.eyebrow": "How I work", "proc.h2": "A process that looks <span class=\"serif\">expensive</span>", "proc.lead": "Transparent stages from the first call to launch and support.",
      ...
      "pr.eyebrow": "Service packages", "pr.h2": "Transparent <span class=\"grad\">pricing</span>", "pr.lead": "Starting prices are indicative — the final quote is always tailored to your scope.",
      ...
      "ct.eyebrow": "Ready to start?", "ct.h2": "Let’s create something <span class=\"serif\">memorable</span>", "ct.lead": "Tell me about your idea — and see first concepts as soon as tomorrow. Pick a direction or message me directly.",
      "ct.q1": "Order AI project", "ct.q2": "Discuss a website", "ct.q3": "Create AI content",
      ...
      "ft.tag": "Marina Kalashnikova — AI Creator and digital automation specialist. Cinematic AI content and digital products for your brand.",
