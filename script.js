...
(function () {
  ...
  var dict = {
    ru: {
      ...
      "hero.pill": "AI Creator Studio · Премиальный AI-продакшн",
      "hero.title": "Превращаю бренды в<br /><span class=\"grad\">кинематографичные</span> <span class=\"serif\">AI-истории</span>",
      "hero.sub": "<strong>Marina Kalashnikova</strong> — AI Creator и архитектор цифровой автоматизации. Создаю премиальный визуал, видео, виртуальные образы, сайты и интеллектуальные системы, что звучат как единая эстетика вашего бренда — от первого кадра до автоматизированного запуска.",
    ...
    en: {
      ...
      "hero.pill": "AI Creator Studio · Premium AI production",
      "hero.title": "Turning brands into<br /><span class=\"grad\">cinematic</span> <span class=\"serif\">AI stories</span>",
      "hero.sub": "<strong>Marina Kalashnikova</strong> — AI Creator and digital automation architect. I craft premium visuals, video, virtual personas, websites and intelligent systems that read as one cohesive brand aesthetic — from the first frame to an automated launch.",
