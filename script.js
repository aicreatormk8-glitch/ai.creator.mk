...
(function () {
  ...
  var dict = {
    ru: {
      ...
      "proc.eyebrow": "Как я работаю", "proc.h2": "От идеи до продукта, <span class=\"serif\">который работает</span>", "proc.lead": "Прозрачные этапы и личное сопровождение — от первого брифа до запуска и дальнейшего развития.",
    ...
    en: {
      ...
      "proc.eyebrow": "How I work", "proc.h2": "From idea to product <span class=\"serif\">that works</span>", "proc.lead": "Transparent stages and personal guidance — from the first brief to launch and beyond.",
