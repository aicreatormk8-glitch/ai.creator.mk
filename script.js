...
(function () {
  ...
  /* ── Contact form → Formspree (direct to email) ── */
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      hint.textContent = (currentLang === "ru")
        ...
        : currentLang === "en" ? "Sending your request…" : "Відправляємо вашу заявку…";
      hint.style.color = "";
    });
  }
  ...
  var dict = {
    ru: {
      ...
      "w1.tag": "AI-генерация · Luxury Fashion", "w1.h3": "Kolekcija «Aurora»", "w1.p": "Кинематографичная кампания с 240+ премиальных AI-образов для итальянского дома моды. Мировая эстетика, граничные детали.",
      "w2.tag": "Кинематография · Cinematic", "w2.h3": "Промо-цикл для Luxury Brand", "w2.p": "Серия 15-секундных кинематографичных промо-клипов. Пиксели как искусство, движение как поэзия.",
      "w3.tag": "Digital Avatar · Premium", "w3.h3": "Персонаж «Solaris»", "w3.p": "Целостная цифровая модель для глобального beauty-бренда. 240+ вариаций, один взгляд, вечная элегантность.",
      "w4.tag": "Product Photography · Studio", "w4.h3": "Каталог «Essence»", "w4.p": "320 студийных AI-кадров для премиум-косметики. Каждая деталь, каждый свет, каждая тень — контролируемые и идеальные.",
      "w5.tag": "Web Design · Premium", "w5.h3": "Фешн-лендинг «Ethereal»", "w5.p": "Элегантный односторонний сайт для глобального fashion-дома. Минимализм, скорость, конверсия как форма искусства.",
      ...
      "w7.tag": "Visual Identity · Complete", "w7.h3": "Бренд-гайдлайн «Luminous»", "w7.p": "Завершённая визуальная система: палитра, типография, AI-образы, 180-страничный гайдлайн для швейцарского бренда.",
      "w8.tag": "Film · 4K Campaign", "w8.h3": "Кейс «Next Dimension»", "w8.p": "45-секундная премиальная кампания от концепции до 4K деплоя. Мировой уровень, кадр за кадром.",
      "w9.tag": "Social · Visual Strategy", "w9.h3": "Контент-архив для @Luxe_Studio", "w9.p": "180 органических постов AI-поколения в единой эстетике. Стиль бренда в каждом пикселе, 6 месяцев контента.",
      ...
      "vc2.text": "«Премиальный сайт и кинематографичный контент. Скорость и качество, которых мы не ожидали от AI.»", "vc2.role": "CMO, SaaS Startup",
      ...
      "f.msg": "Детали проекта", "f.msg.ph": "Несколько слов о задаче, сроках и бюджете", "f.btn": "Отправить заявку", "f.hint": "Заявка будет отправлена вам на почту.",
      "ft.tag": "AI Creator & Visual Director. Создаю кинематографичный AI-контент, рекламу и премиальные цифровые продукты для брендов, которые хотят быть исключительными. От fashion-визуализации до luxury-сайтов — каждая деталь создана, чтобы захватывать с первого взгляда. Каждый кадр — уровень мирового глянца.",
    ...
    en: {
      ...
      “w1.tag”: “AI generation · Luxury Fashion”, “w1.h3”: “Kolekcija «Aurora»”, “w1.p”: “Cinematic campaign with 240+ premium AI images for an Italian fashion house. World-class aesthetics, refined details.”,
      "w2.tag": "Cinematography · Cinematic", "w2.h3": "Promo cycle for Luxury Brand", "w2.p": "A series of 15-second cinematic promo clips. Pixels as art, movement as poetry.",
      “w3.tag”: “Digital Avatar · Premium”, “w3.h3”: “Character «Solaris»”, “w3.p”: “A complete digital model for a global beauty brand. 240+ variations, one look, timeless elegance.”,
      "w4.tag": "Product Photography · Studio", "w4.h3": "Catalog «Essence»", "w4.p": "320 studio AI frames for premium cosmetics. Every detail, every light, every shadow — controlled and perfect.",
      "w5.tag": "Web Design · Premium", "w5.h3": "Fashion landing «Ethereal»", "w5.p": "Elegant one-page website for a global fashion house. Minimalism, speed, conversion as art form.",
      "w6.tag": "AI automation", "w6.h3": "Content workflow for an agency", "w6.p": "Automated generation & publishing pipeline — minus 60% routine.",
      “w7.tag”: “Visual Identity · Complete”, “w7.h3”: “Brand guideline «Luminous»”, “w7.p”: “Complete visual system: palette, typography, AI imagery, 180-page guideline for a Swiss brand.”,
      "w8.tag": "Film · 4K Campaign", "w8.h3": "Case «Next Dimension»", "w8.p": "45-second premium campaign from concept to 4K deploy. World-class level, frame by frame.",
      "w9.tag": "Social · Visual Strategy", "w9.h3": "Content archive for @Luxe_Studio", "w9.p": "180 organic AI-generated posts in unified aesthetic. Brand style in every pixel, 6 months of content.",
      ...
      “vc2.text”: “”Premium website and cinematic content. Speed and quality we didn’t expect from AI.””, “vc2.role”: “CMO, SaaS Startup”,
      ...
      "f.msg": "Project details", "f.msg.ph": "A few words about the task, timeline and budget", "f.btn": "Send request", "f.hint": "Your request will be sent to your email.",
      "ft.tag": "AI Creator & Visual Director. I create cinematic AI content, advertising and premium digital products for brands that strive to be exceptional. From fashion visualization to luxury websites — every detail is designed to captivate from the first glance. Every frame is world-class glamour.",
  ...
  var marqueeTerms = {
    uk: ["AI-фотогенерація", "AI-відео", "Віртуальні інфлюенсери", "Предметна зйомка", "UGC-реклама", "Сайти під ключ", "Бренд-контент"],
    ru: ["AI-фотогенерация", "AI-видео", "Виртуальные инфлюенсеры", "Предметная съёмка", "UGC-реклама", "Сайты под ключ", "Бренд-контент"],
    en: ["AI photo generation", "AI video", "Virtual influencers", "Product photography", "UGC ads", "Turnkey websites", "Brand content"]
  };
